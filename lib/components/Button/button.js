...
export var Button = function (props) {
    ...
    if (btnType === 'link' && href) {
        return (React.createElement("a", __assign({ "data-test": "link", className: classes, href: href }, restProps), children));
    }
    else {
        return (React.createElement("button", __assign({ "data-test": "button", className: classes, disabled: disabled }, restProps), children));
    }
};
